...
\begin{itemize}
    ...
    \item The admin dashboard can announce the next token through browser voice synthesis using both token number and customer name.
    \item The admin can filter token records for a selected date range.
