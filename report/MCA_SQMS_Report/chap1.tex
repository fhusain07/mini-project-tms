...
\begin{enumerate}
    ...
    \item Provides an audible browser-based announcement using token number and customer name.
    \item Supports date-wise filtering of token records for administrative review.
...
\begin{itemize}
    ...
    \item To integrate browser voice synthesis for token calling announcements.
    \item To provide date range based filtering for token records in the admin dashboard.
...
\begin{itemize}
    ...
    \item \textbf{Admin Module:} Login, token management, queue reset, date range filtering, and browser voice announcement for administrators.
